...
vi.mock('../components/WeekDayColumn/WeekDayColumn.jsx', () => ({
  default: ({ day }) => { //1. Direct destructuring and curly braces for function body.
    ...
    return ( //2. Explicit return statement.
...
//Mock EventPanel.jsx.
vi.mock('../components/EventPanel/EventPanel.jsx', () => ({
  default: ({ selectedEvent, onClose }) => (
...
vi.mock('../hooks/useEvents', () => ({
  useEvents: () => ({
    events: mockEventsList, //empty array of events, always the same.

...
describe('WeekDayColumn', () => {
  ...
  test('renders the WeekDayColumn component successfully.', () => {
    render(
      <WeekDayColumn
        day={mockDay}
        groupedEvents={{}}
    ...
    //The component should render exactly one section element.
    const sections = document.querySelectorAll('section.weekday-column');
  ...
  test('has an aria-label describing the schedule for the given day.', () => {
    ...
    const expectedAriaLabel = `Events for ${mockDay.toUTCString().split(' ').slice(0, 4).join(' ')}`
